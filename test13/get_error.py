...
def get_AEV_result(pdb_inp, cut_num):
  ...
  CC_value = aev.compare(a, [0,0.95,0.05])
  # print(CC_value)
...
def run(args):
  ...
  v1 = get_AEV_result(pdb_inp, cut_num=[0.98, 5])
  ...
  v5 = get_ss(hierarchy=pdb_hierarchy, method="cablam")
  ...
  print("cablam and standard:", flex.linear_correlation(x=v5, y=v4).coefficient())
