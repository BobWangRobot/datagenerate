...
def reject_or_trim(helix, hierarchy):
  ...
  for three in generate_protein_threes(hierarchy=hh, geometry=None):
    # print(three[-1].atoms()[-1].i_seq)
    selection = three[-1].atoms()[-1].i_seq
    # print(type(selection))
    start = get_ids(atoms=atoms, i=selection)
    # print(start)
...
def run(args):
  ...
  # print("from_ca type", type(from_ca))
